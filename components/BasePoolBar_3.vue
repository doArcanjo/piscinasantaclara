...
<div class="rcorners1">
  ...
  <h2>pH: {{poolPH}}</h2>
  <h2>Temperatura: {{poolTemperatura}} ºC</h2>
  <h2>Cloro: {{poolCloro}} ppm</h2>
</div>
</template>
<script>
  const kWidth=50;
...
.rcorners1 {
  ...
  background: linear-gradient(45deg, #d0e4f7 0%,#73b1e7 24%,#0a77d5 50%,#539fe1 79%,#87bcea 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
